      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          ...
          <div className="relative group">
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-zinc-800 to-zinc-900 border border-white/10">
          ...
          <div className="space-y-6">
            <div className="prose prose-invert max-w-none">
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                ...
                lahir dari passion kami terhadap streetwear dan keinginan untuk
                menghadirkan fashion lokal berkualitas tinggi yang authentic dan
                affordable.
              </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => (
            ...
            >
              ...
              {/* Hover Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/0 to-orange-500/0 group-hover:from-orange-500/5 group-hover:to-transparent rounded-xl transition-all duration-300 pointer-events-none" />
            </div>
          ))}
        </div>
