...
export const OrderStatusTracker: React.FC<OrderStatusTrackerProps> = ({
  ...
  const cancelledSteps = [
    { key: "waiting", label: "Pesanan Dibuat", icon: FaClock },
    { key: "cancelled", label: "Dibatalkan", icon: FiXCircle },
  ];

  const steps = currentStatus === "cancelled" ? cancelledSteps : normalSteps;
  ...
  const themeColorClass = isCancelled ? "bg-red-500" : "bg-green-500";
  const themeRingClass = isCancelled ? "ring-red-100" : "ring-green-100";
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="relative">
        ...
        <div className="absolute top-5 left-0 right-0 h-0.5 bg-gray-200 hidden md:block">
          <div
            className={"h-full transition-all duration-500 " + themeColorClass}
            style={{
              width: isCancelled
                ? "100%"
            ...
            return (
              ...
              >
                <div
                  ...
                  } ${isCurrent ? "ring-4 " + themeRingClass : ""}`}
                >
